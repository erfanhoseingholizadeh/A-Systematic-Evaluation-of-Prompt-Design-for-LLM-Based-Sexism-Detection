...
% Anonymized 2026-08-25 for double-blind review submission. Real author
% list (restore at camera-ready): Erfan Hoseingholizadeh, Shakiba
% Mirbagheri, Mina Farmanbar.
...
\begin{IEEEkeywords}
sexism detection, prompt engineering, large language models,
in-context learning, chain-of-thought prompting, hate speech detection
\end{IEEEkeywords}
